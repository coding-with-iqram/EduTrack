  ...
  return (
    <div className="previous-questions p-4 max-w-3xl mx-auto">
      ...
      <p className="mb-6 text-gray-700">
        Here you can view all your previous questions and answers categorized by type.
      </p>
      ...
      <div className="flex gap-4 mb-6">
        <button
          className={`px-4 py-2 rounded ${
            selectedType === "veryshort" ? "bg-blue-600 text-white" : "bg-gray-200"
          }`}
        ...
        <button
          className={`px-4 py-2 rounded ${
            selectedType === "short" ? "bg-blue-600 text-white" : "bg-gray-200"
          }`}
      ...
      {selectedType === "veryshort" && (
        <section className="mb-8">
          ...
          {VeryShortQuestions.map((q, index) => (
            <div key={index} className="p-4 border rounded-md mb-4 shadow-sm bg-white">
              ...
              <p className="text-gray-700 whitespace-preline mt-1">Answer: {q.answer}</p>
            </div>
          ))}
        </section>
      )}
